...
./fdwctl --config ${CONFIGFILE} create schema --servername remotedb1 --localschema remotedb1 --remoteschema public --importenums --enumconnection "postgres://postgres:passw0rd@localhost:15432/remotedb?sslmode=disable"
